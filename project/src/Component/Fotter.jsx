...
<div className="flex  gap-4 py-10">
      <div className="w-[60%]">
        <div className="text-[10vw] font-[font1] leading-[9vw]">
          <h1>EYE -</h1>
          <h1>OPENING</h1>
        </div>
      </div>
      <div className=" w-full pl-4">
        <h1 className="font-[font1] text-[7vw]">PRESENTATION </h1>
        <div className="flex  justify-between mt-4 ">
          <div className="flex flex-col   ">
            <h2 className="mb-2 text-2xl">s:</h2>
            {["Instagram", "Behance", "Facebook", "linkdin"].map(
              (item, index) => (
                <a href="#" key={index} className="line2  relative">
                  {item}
                </a>
              )
            )}

            <h2 className="my-2  text-2xl">L:</h2>
            {[
              "202-1965 W 4th Ave",
              "Vancouver Canada",
              "30 Chukarina St",
              ...
              <a
                ...
                className={`line2  relative ${index > 1? "mb-4" : ""}`}
              >
                {item}
              </a>
            ))}
          ...
          <div className="flex flex-col justify-end ">
            <h2 className="mb-4 text-2xl"> M:</h2>
            {[
              "Home",
              "Services",
              "Overwork",
      ...
      <div className="flex items-center justify-between p-4">
        ...
        <div>
          <p className="text-zinc-400">© ochi design 2025. Legal Terms</p>
        </div>
        <div><p className="text-zinc-400">Website by Obys
</p></div>
        </div> 
    </div>
  );
