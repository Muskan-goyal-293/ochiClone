...
function Navbar() {  
  return (
    <div>
      <nav className="w-full p-4 bg-gradient-to-t from-zinc-100/30 to-transparent  backdrop-blur-sm flex items-center justify-between  fixed top-0">
        <div>
          <svg
            width="72"
            height="30"
          ...
          {["services", "Our work", "About us", "Insights", "Contact us"].map(
            (item, index) => (
              <a
                href="#"
                key={index}
                className={`capitalize  ml-10 font-[font4]  ${
                  index == 4 && "ml-80"
                }`}
              >
                {item}
